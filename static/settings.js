...
window.onload = function () {
  ...
  const thingies = document.querySelectorAll('.settingsBox .switch .slider');
...
function drawSetting(settingText, checked) {
  ...
  const boxPart1 = '<div class="settingsBox"><span class="settingsText">'; // setting text
  const boxPart2 = '</span><label class="switch"><input type="checkbox"'; // either checked or nothing
  const boxPart3 = '><div class="slider"></div></label></div>'; // comment for balance and looks
